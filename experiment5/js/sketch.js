...
function resizeScreen() {
  centerHorz = canvasContainer.width() / windowOffset; // Adjusted for drawing logic
  centerVert = canvasContainer.height() / windowOffset; // Adjusted for drawing logic
  console.log("Resizing...");
  resizeCanvas(canvasContainer.width()/windowOffset, canvasContainer.height()/windowOffset);
